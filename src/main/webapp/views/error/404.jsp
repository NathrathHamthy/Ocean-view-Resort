...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .error-code{font-size:7rem;font-weight:900;color:#1A6B8A;line-height:1;}
...
<body>
    <div class="error-box">
        ...
        <div class="error-msg">The page you are looking for doesn't exist or has been moved.</div>
